...
# tag="l13_transformer_irm" # tag for managing experiments.
# train_config=conf/train_transformer_irm.yaml
...
tag="l13_transformer_irm_c" # tag for managing experiments.
train_config=conf/train_transformer_irm.yaml
lm_config=conf/lm.yaml
decode_config=conf/decode_transformer.yaml
babel_langs="307 103 101 402 107 206 404 203 505"
...
gp_recog="Czech Mandarin Spanish Thai"
# Generate configs with local/prepare_experiment_configs.py
resume=exp/train_pytorch_l13_transformer_irm_c/results/snapshot.ep.15
langs_config=
