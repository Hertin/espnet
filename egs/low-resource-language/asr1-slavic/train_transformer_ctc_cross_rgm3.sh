...
tag="l15_transformer_ctc_cross_rgm3_run_k1_lmd_0.01_e6_phs_aware_h" # tag for managing experiments.
train_config=conf/train_transformer_ctconly_rgm3_run_k1_lmd_0.01_e6_phs_aware_h.yaml
