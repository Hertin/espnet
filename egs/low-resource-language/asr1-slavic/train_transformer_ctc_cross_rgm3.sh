...
tag="l15_transformer_ctc_cross_rgm3_run_k1_lmd_0.05_e3" # tag for managing experiments.
train_config=conf/train_transformer_ctconly_rgm3_run_k1_lmd_0.05_e3.yaml
